...
- [tools.md](tools.md) — CI, build, local dev [updated: 2026-04-26]
- [domain.md](domain.md) — business rules, data models [updated: YYYY-MM-DD]
- [decisions.md](decisions.md) — architecture choices [updated: 2026-04-26]
- [context.md](context.md) — current focus [updated: YYYY-MM-DD]
- [troubleshooting.md](troubleshooting.md) — known issues [updated: 2026-04-26]
